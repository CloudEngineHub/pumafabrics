...
"""
class example_kinova_tamedpuma_3D_hierarchical(TamedPUMAhierarchical):
    def __init__(self, file_name="kinova_ModulationIK_tomato", path_config="../pumafabrics/tamed_puma/config/", mode_NN="1st"):
