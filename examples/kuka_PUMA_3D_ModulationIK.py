...
def main(render=True):
    ...
    positions_obstacles_list = [
        ...
        # # #others:
        [[0.1, -0.56, 0.3], [0.5, 0., 10.1]],  # 0, 5
        [[0.15, -0.6, 0.3], [0.5, 0.15, 0.2]],  # 1, 6
        [[-0.1, -0.72, 0.22], [0.6, 0.02, 10.2]],  # 2, 7
        [[-0.1, -0.72, 0.22], [0.3, -0.1, 10.5]],  # 3, 8
        [[-0.1, -0.72, 0.22], [0.5, 0.2, 10.25]],  # 4, 9
    ...
    example_class.overwrite_defaults(params=example_class.params, init_pos=q_init_list[1],
                                     positions_obstacles=positions_obstacles_list[1],
                                     speed_obstacles=speed_obstacles_list[1],
