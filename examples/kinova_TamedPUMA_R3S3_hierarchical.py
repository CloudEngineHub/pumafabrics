...
class example_kinova_tamedpuma_R3S3_hierarchical(TamedPUMAhierarchical):
    def __init__(self, file_name="kinova_hierarchical_tomato", path_config="/../config/", mode_NN="1st"):
...
def main(render=True, n_steps=None):
    q_init_list = [
        ...
        np.array((-0.00020932446168022814, -0.00016405072314888108, 0.00015339807878856412, 1.6997401951899171, 1.571686355231201, -1.5708027183815128))
    ]
