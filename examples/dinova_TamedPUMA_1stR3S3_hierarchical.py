...
"""
class example_dinova_tamedpuma_R3S3_hierarchical(ExampleGeneric):
    def __init__(self, file_name="dinova_hierarchical_tomato", path_config="../pumafabrics/tamed_puma/config/"):
...
def main(render=True, n_steps=None):
    ...
    example_class = example_dinova_tamedpuma_R3S3_hierarchical()
