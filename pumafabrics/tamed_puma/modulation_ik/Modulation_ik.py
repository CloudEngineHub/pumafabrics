...
class IKGomp():
    ...
    def construct_ik(self, nr_obst=0, collision_links=None, tolerance_rotation=10.):
        # URDF model
        ...
        self.planner.add_orientation_constraint(name="g_rotation", tolerance=tolerance_rotation)
