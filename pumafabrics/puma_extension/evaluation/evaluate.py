import numpy as np
import torch
from pumafabrics.puma_extension.evaluation.utils.saving import save_stats_txt, save_best_stats_txt, check_gpu
from pumafabrics.puma_extension.evaluation.utils.similarity_measures import get_RMSE, get_FD, get_DTWD
