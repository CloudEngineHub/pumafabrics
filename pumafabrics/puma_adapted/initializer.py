...
from pumafabrics.puma_adapted.data_preprocessing.data_preprocessor import DataPreprocessor
from pumafabrics.puma_adapted.agent.contrastive_imitation import ContrastiveImitation
from pumafabrics.puma_adapted.evaluation.evaluator_init import evaluator_init
...
def initialize_framework(params, name_params, verbose=True):
    ...
    if params.save_evaluation:
        ...
        print("params.results_path: {}".format(params.results_path))
