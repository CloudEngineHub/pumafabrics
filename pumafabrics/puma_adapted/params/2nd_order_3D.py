...
class Params:
    ...
    results_path: str = 'results/2nd_order_3D/'
    ...
    imitation_loss_weight: float = 0  # imitation loss weight #todo: set to 1!!
    stabilization_loss_weight: float = 0.93  # stability loss weight
    boundary_loss_weight: float = 0.1 # boundary loss weight #todo: 0.001
    ...
    max_iterations: int = 8000 #41000  # maximum number of training iterations
