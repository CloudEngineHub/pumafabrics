...
class Params:
    ...
    results_path: str = 'results/2nd_order_R3S3_converge2/'
    ...
    manifold_dimensions: int = 7  # dimensionality of the data manifold
    ...
    boundary_loss_weight: float = 1.5  # boundary loss weight
    ...
    max_iterations: int = 2000 #48000 #48000  # maximum number of training iterations
