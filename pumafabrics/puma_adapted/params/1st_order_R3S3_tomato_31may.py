...
class Params:
    ...
    results_path: str = 'results/1st_order_R3S3_tomato_31may/'
    ...
    boundary_loss_weight: float = 0.01  # boundary loss weight
    ...
    max_iterations: int = 10000 #48000  # maximum number of training iterations
