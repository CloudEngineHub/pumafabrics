...
class example_kuka_stableMP_fabrics_3D_2nd:
    ...
    def run_kuka_example(self, n_steps=2000, env=None, goal=None, init_pos=np.array([0.0, 0.0, 0.]), goal_pos=[0.1, -0.6, 0.4], mode="acc", mode_NN="2nd", dt=0.01):
        # --- parameters --- #
        dof = 7
        dim_task = 3
        ...
        if mode_NN == "2nd":
            ...
            params_name = " "
            print("No such mode of the NN is defined. Use 1st or 2nd")
        ...
        for w in range(n_steps):
            ...
            if mode_NN == "2nd":
                ...
                action_safeMP_pulled_old = geometry_safeMP.get_numerical_vel_pulled(q_num=q, h_NN=action_safeMP)
                action_safeMP_pulled = kuka_kinematics.get_qdot_from_linear_velocity(q=q, xdot=action_safeMP)
            ...
            ob, *_ = env.step(action_safeMP_pulled) #action_fabrics_safeMP
...
if __name__ == "__main__":
    ...
    mode = "vel"
    mode_NN = "1st"
    if mode == "vel" and mode_NN == "2nd":
        print("error: this combination of modes is not allowed!")
    dt = 0.01
    nr_obst = 0
